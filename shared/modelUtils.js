...
module.exports = ModelUtils = (function() {
  ...
  ModelUtils.underscorize = function(name) {
    if (name == null) {
      return undefined;
    }
    name = name.replace(this.uppercaseRe, function(c) {
  ...
  ModelUtils.prototype.underscorize = function(name) {
    return ModelUtils.underscorize(name);
  };
  ...
  */
  ...
  ModelUtils.prototype.modelName = function(modelOrCollectionClass) {
    return ModelUtils.underscorize(modelOrCollectionClass.id || modelOrCollectionClass.name);
  };
